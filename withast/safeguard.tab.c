...
{
       0,    65,    65,    71,    72,    77,    79,    85,    86,    91,
      92,    93,    94,    95,    96,    97,   101,   106,   113,   114,
     119,   121,   123,   128,   133,   135,   140,   145,   147,   152,
     156,   157,   162,   163,   165,   170,   171,   173,   175,   177,
     182,   183,   185,   190,   191,   193,   195,   200,   201,   206,
     207,   209,   211,   215,   221,   222,   226,   228,   233,   234,
     236,   238,   240,   242,   249,   252,   258
};
#endif
...
#line 66 "safeguard.y"
    { ast_root = create_program_node((yyvsp[0].node_list_ptr)); /* $$ = ast_root; if program itself is a node */ }
...
#line 97 "safeguard.y"
                            { (yyval.node_ptr) = create_empty_stmt_node(current_line); }
#line 1441 "safeguard.tab.c"
    break;

  case 16: /* block_statement: LBRACE statement_list RBRACE  */
#line 102 "safeguard.y"
    { (yyval.node_ptr) = create_block_stmt_node((yyvsp[-1].node_list_ptr), yyloc.first_line); }
#line 1447 "safeguard.tab.c"
    break;

  case 17: /* var_declaration: LET IDENTIFIER COLON type_specifier optional_initializer SEMICOLON  */
#line 108 "safeguard.y"
    { (yyval.node_ptr) = create_var_decl_node((yyvsp[-4].str_val), (yyvsp[-2].node_ptr), (yyvsp[-1].node_ptr), (yylsp[-5]).first_line); /* $2 (IDENTIFIER) is taken by create_var_decl_node */ }
...
#line 124 "safeguard.y"
    { (yyval.node_ptr) = create_type_spec_node("array", (yyvsp[-3].int_val), (yylsp[-5]).first_line); /* Assuming element type is number */ }
#line 1483 "safeguard.tab.c"
    break;

  case 23: /* expression_statement: expression SEMICOLON  */
#line 129 "safeguard.y"
    { (yyval.node_ptr) = create_expression_stmt_node((yyvsp[-1].node_ptr), (yylsp[-1]).first_line); }
#line 1489 "safeguard.tab.c"
    break;

  case 24: /* if_statement: IF LPAREN expression RPAREN statement  */
#line 134 "safeguard.y"
...
#line 208 "safeguard.y"
    { (yyval.node_ptr) = create_array_access_node((yyvsp[-3].node_ptr), (yyvsp[-1].node_ptr), (yylsp[-2]).first_line); }
#line 1651 "safeguard.tab.c"
    break;

  case 51: /* postfix_expression: postfix_expression LPAREN argument_expression_list_opt RPAREN  */
#line 210 "safeguard.y"
    { (yyval.node_ptr) = create_function_call_node((yyvsp[-3].node_ptr), (yyvsp[-1].node_list_ptr), (yylsp[-2]).first_line); }
#line 1657 "safeguard.tab.c"
    break;

  case 52: /* postfix_expression: PRINT_NUMBER_FN LPAREN expression RPAREN  */
#line 213 "safeguard.y"
    { ASTNode* func_name_node = create_identifier_node(strdup("print_number"), (yylsp[-3]).first_line); /* Kludge if PRINT_NUMBER_FN is not an ID */
...
#line 237 "safeguard.y"
    { (yyval.node_ptr) = create_string_literal_node((yyvsp[0].str_val), (yylsp[0]).first_line); /* $1 (string) is taken by create_string_literal_node */ }
...
#line 243 "safeguard.y"
    { (yyval.node_ptr) = create_size_of_call_node((yyvsp[-1].str_val), (yylsp[-3]).first_line); /* $3 (IDENTIFIER string) is taken by create_size_of_call_node */ }
#line 1731 "safeguard.tab.c"
    break;

  case 64: /* lvalue: IDENTIFIER  */
#line 251 "safeguard.y"
...
#line 254 "safeguard.y"
    { (yyval.node_ptr) = create_array_access_node((yyvsp[-3].node_ptr), (yyvsp[-1].node_ptr), (yylsp[-2]).first_line); /* This is an lvalue array access */ }
...
#line 260 "safeguard.y"
    { (yyval.node_ptr) = create_func_def_node((yyvsp[-5].str_val), /* params_list_node, */ (yyvsp[-1].node_ptr), (yyvsp[0].node_ptr), (yylsp[-6]).first_line); /* $2 taken by create_func_def_node */ }
